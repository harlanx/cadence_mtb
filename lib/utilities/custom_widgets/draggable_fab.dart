...
//=======================================================================
/// Draggable Floating Action Button widget which is always aligned to
  ...
  void _calculatePosition(Offset targetOffset) {
    ...
    switch (_getAnchor(targetOffset)) {
      case Anchor.LEFT_FIRST:
        ...
        this._top = math.max(_widgetSize.height / 2, targetOffset.dy);
        break;
      case Anchor.TOP_FIRST:
        this._left = math.max(_widgetSize.width / 2, targetOffset.dx);
