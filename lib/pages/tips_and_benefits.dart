...
class _TipsAndBenefitsState extends State<TipsAndBenefits> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _tipsItems.sort((a, b) => a.title.compareTo(b.title));
    _tSearchList = _tipsItems;
    _benefitsItems.sort((a, b) => a.title.compareTo(b.title));
    _bSearchList = _benefitsItems;
  }
...
final List<ArticleItem> _benefitsItems = [
  //BENEFITS LIST
  ArticleItem(
